        ...
        <nav class="navbar navbar-light bg-light static-top">
            <div class="container">
                <a class="navbar-brand" href="index.php">
                    <img src="assets/logo-small.png" alt="File Share logo: a white folder with the letters F and S written on it in blue.">
                    <span class="align-middle">File Share</span>
                </a>
                <a class="btn btn-primary rounded-5" href="signin.php">Sign In</a>
            </div>
        </nav>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="text-center text-white">
                            ...
                            <a class="btn btn-primary btn-lg rounded-5" href="signup.php">Create a Free Account</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                        <ul class="list-inline mb-2">
                            <li class="list-inline-item"><a href="signin.php">Sign In</a></li>
                            <li class="list-inline-item">⋅</li>
                            <li class="list-inline-item"><a href="signup.php">Sign Up</a></li>
